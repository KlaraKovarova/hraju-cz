...
const FERRATY: FerrataData[] = [
  ...
  {
    name: "Stolanský lom",
    slug: "stolansky-lom-stolany",
    description: "Zkušební mini via ferrata obtížnosti B u obce Stolany. Převýšení 7 m, délka trasy 30 m. Ideální pro první seznámení s ferratami.",
    address: "Stolany, Rabštějnská Lhota",
    city: "Stolany",
    region: "Pardubický kraj",
    lat: 49.9163,
    lng: 15.7491,
  ...
  // PLZEŇSKÝ KRAJ
  {
    name: "Doubravecké Ferátky",
    slug: "doubravecke-feratky-plzen",
    description: "Tři ferratové trasy (Slunečná, Levka a Pravka, Hřebínek) v údolí Berounky u Doubravky v Plzni. Volně přístupné po registraci. Provozuje SKP RAPID Plzeň.",
    address: "Doubravka, Plzeň",
    city: "Plzeň",
    region: "Plzeňský kraj",
    lat: 49.7660,
    lng: 13.3880,
    website: "https://www.doubraveckeferatky.cz",
  },
  // LIBERECKÝ KRAJ
  {
    name: "SKAB – Skály Bezděčín",
    slug: "skab-skaly-bezdecin",
    description: "Ferrata na pískovcové Bezděčínské věži u Hodkovic nad Mohelkou. Délka cca 80 m, dva úseky — první jednodušší, druhý s traverzami a převisy. Přístup po registraci, omezená kapacita.",
    address: "Bezděčín, Hodkovice nad Mohelkou",
    city: "Hodkovice nad Mohelkou",
    region: "Liberecký kraj",
    lat: 50.6618,
    lng: 15.1306,
    website: "https://www.skab.cz",
  },
  // MORAVSKOSLEZSKÝ KRAJ
  {
    name: "Ludvíkovské skalní město",
    slug: "ludvikovske-skalni-mesto-ludvikov",
    description: "Zajištěná cesta obtížnosti A/B v Hrubém Jeseníku u Ludvíkova. Délka 80 m, převýšení 100 m. 5 úseků propojených ocelovými lany, skalní okno a úkryt pro bivak.",
    address: "Ludvíkov, Vrbno pod Pradědem",
  ...
  {
    name: "Via Ferrata Bazaly",
    slug: "via-ferrata-bazaly-ostrava",
    description: "Krátká via ferrata obtížnosti B/C na betonové zdi v parku Bazaly v Ostravě. Délka 30 m. Vhodná pro nácvik práce s karabinami a úvod do ferrat.",
    address: "Bazaly, Ostrava",
    city: "Ostrava",
    region: "Moravskoslezský kraj",
    lat: 49.8429,
    lng: 18.3008,
