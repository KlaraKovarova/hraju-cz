...
// POST /api/admin/conditions/[id]/hide — hide a condition report from public view
export async function POST(
  ...
  console.info(
    `[admin-audit] hide conditionReport id=${id} facilityId=${existing.facilityId} userId=${existing.userId}`
  );
